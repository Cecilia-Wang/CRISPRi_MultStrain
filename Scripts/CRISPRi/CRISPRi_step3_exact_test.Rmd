...
migs.runs<-c("4320a2","4320b2","4320c2","5440b", "5767a","5767b","5767c","5767d")
...
ProjectDIR<-"Results/CRISPRi/data_long/"
...
############# Please note that the following analysis will only run with full datasets (which are too big to be uploaded to github), test sets will cause partial error as subset data is incomplete for comparison ############# 
# partial run for 5767a test set, one figure will be generated with the datapoints, but won't have full results
